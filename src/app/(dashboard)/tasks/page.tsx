                    ...
                    <div className="flex gap-6 h-[85vh] min-h-[800px] min-w-[1000px] pb-4 px-1">
                        ...
                        {(["Todo", "In Progress", "Done"] as const).map((status) => {
                            ...
                            return (
                                <div
                                    key={status}
                                    id={status} // Important: This ID allows dropping directly on empty column
                                    className="flex-1 flex flex-col h-full bg-muted/30 dark:bg-muted/10 rounded-2xl border border-white/5 overflow-hidden ring-offset-2 ring-primary/20 hover:ring-2 transition-all"
                                >
