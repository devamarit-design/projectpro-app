...
export default function FeatureCarousel({ onComplete }: FeatureCarouselProps) {
    ...
    const slides = [
        {
            id: 1,
            title: t.onboarding.carousel?.slide1?.title || "Master Your Projects",
            description: t.onboarding.carousel?.slide1?.description || "Plan, track, and deliver construction projects with powerful Kanban boards and timelines.",
        ...
        {
            id: 2,
            title: t.onboarding.carousel?.slide2?.title || "Smart Financials",
            description: t.onboarding.carousel?.slide2?.description || "Control your budget with precision. Scan receipts, track expenses, and manage cash flow in real-time.",
        ...
        {
            id: 3,
            title: t.onboarding.carousel?.slide3?.title || "Professional Documents",
            description: t.onboarding.carousel?.slide3?.description || "Create and manage contracts, invoices, and quotations effortlessly. Keep everything organized.",
        ...
        {
            id: 4,
            title: t.onboarding.carousel?.slide4?.title || "Unified Teamwork",
            description: t.onboarding.carousel?.slide4?.description || "Connect your office and field teams. Assign tasks, share files, and stay in sync anywhere.",
        ...
        <div className="w-full min-h-screen flex flex-col relative overflow-hidden bg-black text-white">
                ...
                <AnimatePresence mode="wait">
                    ...
                    >
                        <img
                            ...
                            alt={`${slides[currentSlide].title} - HipslothProject Feature`}
            ...
            <div className="relative z-10 flex-1 flex flex-col justify-end p-8 sm:p-12 pb-16 max-w-2xl mx-auto w-full">
                ...
                <div className="mt-12 flex items-center justify-between">
                    ...
                    >
                        <span>{currentSlide === slides.length - 1 ? (t.onboarding.carousel?.get_started || "Get Started") : (t.onboarding.carousel?.next || "Next")}</span>
