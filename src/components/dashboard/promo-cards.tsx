...
export function PromoCards() {
    return (
        <div className="grid grid-cols-2 gap-4 mb-8">
            ...
            <Link href="/financial" className="relative group overflow-hidden rounded-2xl bg-gradient-to-br from-orange-500 to-red-500 p-4 h-28 sm:h-32 shadow-lg cursor-pointer hover:shadow-xl transition-all">
            ...
            {/* Right Card - Performance / Pro Features */}
            <Link href="/pro-tools" className="relative group overflow-hidden rounded-2xl bg-gradient-to-br from-blue-600 to-indigo-600 p-4 h-28 sm:h-32 shadow-lg cursor-pointer hover:shadow-xl transition-all">
                <div className="relative z-10 flex flex-col justify-between h-full text-white">
                    <div>
                        <h3 className="font-bold text-lg leading-none mb-1">Pro Tools</h3>
