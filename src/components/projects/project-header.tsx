    ...
    return (
        <>
            <ConfirmDialog
                ...
                message="คุณต้องการ Archive โปรเจคนี้หรือไม่? รายชื่อโปรเจคจะถูกย้ายไปที่หน้า Archive"
                confirmText="Archive"
                cancelText="ยกเลิก"
                variant="warning"
            />
                                    ...
                                    <div className="absolute right-0 top-14 w-56 bg-card/95 backdrop-blur-2xl border border-white/10 rounded-2xl shadow-2xl z-50 overflow-hidden animate-in fade-in zoom-in-95 duration-200">
                                        ...
                                        {project.status === 'Completed' && (
                                            <button
                                                ...
                                                className="w-full flex items-center gap-3 px-5 py-4 hover:bg-amber-500/10 text-amber-500 transition-colors text-sm font-semibold text-left border-t border-white/5"
                                            >
                        ...
                        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-10">
                            <div className="space-y-6 max-w-full lg:max-w-3xl">
                                ...
                                <div className="relative space-y-3">
                                    <h1 className="text-4xl md:text-6xl lg:text-7xl font-semibold font-sans tracking-tighter leading-[1.1] drop-shadow-2xl">
                                        {project.name}
                                    </h1>
