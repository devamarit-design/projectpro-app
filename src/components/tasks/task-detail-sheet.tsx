...
import { X, Calendar, User, Tag, Trash2, Clock, CheckCircle2, Layout, AlignLeft, Hash, ExternalLink, ChevronDown } from "lucide-react"
    ...
    return (
        <div className="fixed inset-0 z-[100] flex justify-end font-sans">
            ...
            <div className="relative w-full max-w-xl bg-card/90 backdrop-blur-3xl border-l border-white/10 shadow-2xl animate-in slide-in-from-right duration-300 flex flex-col h-full">
                {/* Header Actions */}
                <div className="p-6 flex items-center justify-between border-b border-white/5 shrink-0 bg-muted/20">
