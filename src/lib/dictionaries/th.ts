export const th = {
    ...
    policy: {
        last_updated: "อัปเดตล่าสุด: 28 มกราคม 2569",
        data_privacy: {
            title: "ความเป็นส่วนตัวของข้อมูล",
            content: "ที่ HipslothProject เราให้ความสำคัญสูงสุดกับความเป็นส่วนตัวของข้อมูลคุณ เนื่องจากแอปพลิเคชันทำงานเป็น Progressive Web App (PWA) แบบ Local-first ข้อมูลการทำงานของคุณ (ค่าใช้จ่าย, งาน, เอกสาร) จึงถูกจัดเก็บอย่างปลอดภัยบนอุปกรณ์ของคุณและซิงค์ผ่านระบบคลาวด์ที่เข้ารหัส เราปฏิบัติตามมาตรฐานการปกป้องข้อมูลระดับสากลอย่างเคร่งครัดเพื่อให้มั่นใจว่าข้อมูลของคุณจะเป็นความลับ"
        },
        usage_policy: {
            title: "นโยบายการใช้งาน",
            content: "ผู้ใช้เป็นผู้รับผิดชอบต่อความถูกต้องของข้อมูลทางการเงินและเอกสารที่สร้างขึ้นภายในแอป HipslothProject เป็นเครื่องมือบริหารจัดการที่ออกแบบมาเพื่อทีมก่อสร้างและรีโนเวทโดยเฉพาะ แม้เราจะมีระบบติดตามการเงินที่แม่นยำ แต่ซอฟต์แวร์ของเราไม่ได้ถือเป็นการให้คำปรึกษาทางบัญชีหรือกฎหมายอย่างเป็นทางการ ผู้ใช้ควรตรวจสอบรายงานทางการเงินที่สำคัญกับนักบัญชีที่ได้รับอนุญาต"
        },
        security: {
            title: "ความมุ่งมั่นด้านความปลอดภัย",
            points: [
                "การรับส่งข้อมูลเข้ารหัสแบบ End-to-end ระหว่างเครื่องของคุณและเซิร์ฟเวอร์ (TLS 1.3)",
                "ระบบสำรองข้อมูลอัตโนมัติทุกวันสำหรับข้อมูลองค์กรทั้งหมดเพื่อป้องกันการสูญหาย",
                "การควบคุมการเข้าถึงตามบทบาท (RBAC) ที่เข้มงวด เพื่อให้ทีมงานเข้าถึงได้เฉพาะข้อมูลที่จำเป็น",
                "ระบบล็อคแอปรหัส PIN เพื่อป้องกันการเข้าถึงจากผู้อื่นในกรณีที่อุปกรณ์สูญหาย",
                "นโยบายการแยกข้อมูลที่เข้มงวด เพื่อให้มั่นใจว่าข้อมูลองค์กรของคุณจะไม่ปะปนกับผู้อื่น"
            ]
        },
        footer: "สำหรับข้อกำหนดการให้บริการฉบับเต็ม นโยบายความเป็นส่วนตัว หรือสอบถามข้อกฎหมาย โปรดติดต่อที่ support@hipsloth.app"
    },
